...
?>
	...
	<div class="container-fluid">
		...
		<div class="d-sm-flex align-items-center justify-content-between mb-4">
			<h1 class="h3 mb-0 text-gray-800">Áttekintés</h1>
                                                                ...
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <p>Biztos le akarod mondani ezt a foglalást?</p>
                                                                        ...
                                                                        <div class="modal-footer">
                                                                            ...
                                                                            <button type="button" data-id = "<?php echo $row['appointment_id']; ?>" class="btn btn-danger cancel_appointment_button">Igen,lemondom</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
